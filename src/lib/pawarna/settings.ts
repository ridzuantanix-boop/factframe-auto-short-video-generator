export const VIDEO_STYLES = [
  { id: "pov_demo", label: "POV Demo", note: "Tangan, produk dan aksi dekat.", rule: "Hands-only POV. Demonstrate a verified visible function; otherwise handle and showcase the closed product." },
