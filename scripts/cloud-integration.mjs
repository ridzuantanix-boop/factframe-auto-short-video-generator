...
let lastPrompt = ""; let submissions = 0; let analyses = 0; let searches = 0; let planCalls=0; let mode = "success"; let dirtyReference=false;let weakPlans=false;let unsafePlans=false;
...
const mock = createServer(async (req, res) => {
  ...
  if (req.url.includes(":generateContent")) {
    ...
    } else if (content.includes("Audit this Malay script")) value = { safety_safe: true, quality_approved: !weakPlans, reason: weakPlans?"Safe but needs stronger tension":"Supported" };
