...
const output = {
  ...
  globalCount: persisted.stats?.global ?? null, exportedItems: stories.length, exportNote: "Latest 100 rows are included as an audit sample; counts cover the full persisted index.", stories,
};
